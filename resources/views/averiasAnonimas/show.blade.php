    ...
    <x-slot name="header">
        <div class="row">
            ...
            <div class="col text-right">
                <a href="{{ route('averiasAnonimas.index') }}" class="btn btn-primary">Volver</a>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="flex">
                        ...
                        <div class="w-100 pl-4 relative">
                            <div class="rounded overflow-hidden shadow-lg p-4">
                                <h3 class="font-bold text-xl mb-2">Aviso de la Incidencia: {{ $averia->id }}</h3>
                                ...
                                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Email: {{ $averia->email }}</span>
                                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Fecha de inicio: {{ $averia->created_at->format('Y-m-d') }}</span>
                                <div class="px-6 pt-4 pb-2">
